...
(function () {
  ...
  function Wa(h, m, E) {
    "millisecond" === E
      ...
      : "year" === E && h.setFullYear(h.getFullYear() + 1 * m);
    return h;
  }
  function ba(h, m) {
    var E = !1;
  ...
  (function () {
    ...
    ja._fTWm = function (h) {
      if ("undefined" === typeof ja.pro.sCH && !cb)
        try {
          var m,
            r = h[ja.fSDec("buy")];
  ...
  var gb = (function () {
        ...
        if (((m = J[M]), "." === m && 0 > K)) K = M;
          ...
          if ("%" === m) A *= 100;
            ...
            ("E" !== m[0] && "e" !== m[0]) ||
              ...
              (G = !0);
          0 > K
            ? (O.push(m), "#" === m || "0" === m ? P++ : "," === m && W++)
            : (V.push(m), ("#" !== m && "0" !== m) || T++);
        }
      G &&
        ((m = Math.floor(h)),
        (J = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (Q = 0 === h ? 0 : 0 === m ? -(P + J) : String(m).length - P),
        (A /= Math.pow(10, Q)));
      0 > K && (K = M);
      A = (h * A).toFixed(T);
      m = A.split(".");
        ...
        if (((m = O.pop()), "#" === m || "0" === m))
          if ((K++, K === P)) {
            ...
            for (; 0 < X.length; )
              (r = X.pop() + r),
                G++,
                0 === G % J && M === W && 0 < X.length && (r = v + r);
          } else
            0 < A.length
              ? ((r = A.pop() + r), T++, G++)
              : "0" === m && ((r = "0" + r), T++, G++),
              0 === G % J && M === W && 0 < A.length && (r = v + r);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
    ...
    Y = function (h, m, r, w, v, B, A, J, K, O, V, T, P) {
      ...
      0 < A &&
        ...
        (h.strokeStyle = J),
        h.moveTo(m, r),
        h.rect(m - P, r - P, w - m + 2 * P, v - r + 2 * P),
        h.stroke());
      h.restore();
      !0 === K &&
        (h.save(),
        ...
        h.lineTo(w, r),
        h.closePath(),
        (A = h.createLinearGradient((w + m) / 2, r + G, (w + m) / 2, r)),
        A.addColorStop(0, B),
      ...
      !0 === O &&
        ...
        h.lineTo(w, v),
        h.closePath(),
        (A = h.createLinearGradient((w + m) / 2, v - G, (w + m) / 2, v)),
        A.addColorStop(0, B),
        A.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = A),
        h.fill(),
      ...
      !0 === V &&
        ...
        h.lineTo(m, v),
        h.closePath(),
        (A = h.createLinearGradient(m + G, (v + r) / 2, m, (v + r) / 2)),
        A.addColorStop(0, B),
  ...
  G.prototype.setOptions = function (h, m) {
    if (qa[this._defaultsKey]) {
      ...
      for (w in r)
        "publicProperties" !== w &&
          r.hasOwnProperty(w) &&
          (this[w] = h && w in h ? h[w] : m && w in m ? m[w] : r[w]);
  ...
  G.prototype.updateOption = function (h) {
    ...
    this.themeOptions = w;
    h in m &&
      (v = h in this.options ? this.options[h] : w && h in w ? w[h] : m[h]);
  ...
  G.prototype.dispatchEvent = function (h, m, r) {
    if (h && this._eventListeners[h]) {
      ...
      for (var w = this._eventListeners[h], v = 0; v < w.length; v++)
        w[v].eventHandler.call(w[v].context, m);
    }
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((v = m.y2 - 2 - O.height), (K = "bottom")),
          "left" === this.horizontalAlign
            ? (w = m.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = m.x1 + m.width / 2 - O.width / 2)
            : "right" === this.horizontalAlign && (w = m.x2 - 2 - O.width - A),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = m.x1 + 2),
              (v = m.y2 - 2 - (this.maxWidth / 2 - O.width / 2)),
              (B = -90),
              (K = "left"),
              (this.width = O.height),
              (this.height = O.width))
            ...
            ? ((w = m.x2 - 2),
              (v = m.y1 + 2 + (this.maxWidth / 2 - O.width / 2)),
              (B = 90),
              (K = "right"),
              (this.width = O.height),
              (this.height = O.width))
            : "center" === this.horizontalAlign &&
              ((v = h.y1 + (h.height / 2 - O.height / 2)),
  ...
  var Pa = {
    ...
    formatNumber: function (h, r, w) {
      w = w || "en";
      if (Ka[w]) return ca(h, r || "#,##0.##", new Ja(w));
      throw "Unknown Culture Name";
    },
    formatDate: function (h, r, w) {
      w = w || "en";
      if (Ka[w]) return Aa(h, r || "DD MMM YYYY", new Ja(w));
      throw "Unknown Culture Name";
    },
  };
  ...
  B = Pa.Chart = (function () {
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[l].y - a[f].y) / b;
          c[c.length] =
            (a[t].x > a[f].x && 0 < D) || (a[t].x < a[f].x && 0 > D)
              ? { x: a[t].x + D / 3, y: a[t].y + b / 3 }
              : { x: a[t].x, y: a[t].y + b / 9 };
          t = e;
          f = 0 === t ? 0 : t - 1;
          l = t === a.length - 1 ? t : t + 1;
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
          ...
          P(
            ...
            function () {
              a.zoomEnabled
                ? ((a.zoomEnabled = !1),
                  (a.panEnabled = !0),
                  wa(a, a._zoomButton, "zoom"))
                : ((a.zoomEnabled = !0),
                  (a.panEnabled = !1),
                  wa(a, a._zoomButton, "pan"));
              a.render();
            },
            this.allDOMEventHandlers
          );
        ...
        this._resetButton
          ...
          : ((d = !1),
            ...
            wa(this, this._resetButton, "reset"),
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          "line" === t.type
            ? (D = this.renderLine(t))
            : "stepLine" === t.type
            ? (D = this.renderStepLine(t))
            : "spline" === t.type
            ? (D = this.renderSpline(t))
            : "column" === t.type
            ? (D = this.renderColumn(t))
            : "bar" === t.type
            ? (D = this.renderBar(t))
            : "area" === t.type
            ? (D = this.renderArea(t))
            : "stepArea" === t.type
            ? (D = this.renderStepArea(t))
            : "splineArea" === t.type
            ? (D = this.renderSplineArea(t))
            : "stackedColumn" === t.type
            ? (D = this.renderStackedColumn(t))
            : "stackedColumn100" === t.type
            ? (D = this.renderStackedColumn100(t))
            : "stackedBar" === t.type
            ? (D = this.renderStackedBar(t))
            : "stackedBar100" === t.type
            ? (D = this.renderStackedBar100(t))
            : "stackedArea" === t.type
            ? (D = this.renderStackedArea(t))
            : "stackedArea100" === t.type
            ? (D = this.renderStackedArea100(t))
            : "bubble" === t.type
            ? (D = D = this.renderBubble(t))
            : "scatter" === t.type
            ? (D = this.renderScatter(t))
            : "pie" === t.type
            ? this.renderPie(t)
            : "doughnut" === t.type
            ? this.renderPie(t)
            : "funnel" === t.type
            ? (D = this.renderFunnel(t))
            : "pyramid" === t.type
            ? (D = this.renderFunnel(t))
            : "candlestick" === t.type
            ? (D = this.renderCandlestick(t))
            : "ohlc" === t.type
            ? (D = this.renderCandlestick(t))
            : "rangeColumn" === t.type
            ? (D = this.renderRangeColumn(t))
            : "error" === t.type
            ? (D = this.renderError(t))
            : "rangeBar" === t.type
            ? (D = this.renderRangeBar(t))
            : "rangeArea" === t.type
            ? (D = this.renderRangeArea(t))
            : "rangeSplineArea" === t.type
            ? (D = this.renderRangeSplineArea(t))
            : "waterfall" === t.type
            ? (D = this.renderWaterfall(t))
            : "boxAndWhisker" === t.type && (D = this.renderBoxAndWhisker(t));
          for (var k = 0; k < t.dataSeriesIndexes.length; k++)
            this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[k]]);
          this.animatedRender &&
            ((t.targetCanvasCtx.miterLimit = e), D && c.push(D));
        }
          ...
          n._animator.animate(
            ...
            function (a) {
              ...
              n.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(n.width * ma),
                Math.floor(n.height * ma),
                0,
                0,
                n.width,
                n.height
          ...
          if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (t.dataPoints[D].x && t.dataPoints[D].x.getTime) ||
            "dateTime" === t.xValueType
          )
            f = !0;
          for (D = 0; D < t.dataPoints.length; D++) {
            "undefined" === typeof t.dataPoints[D].x &&
              (t.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0));
            t.dataPoints[D].x.getTime
              ? ((f = !0), (b = t.dataPoints[D].x.getTime()))
              : (b = t.dataPoints[D].x);
            e = t.dataPoints[D].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < D) {
              if (a.axisX.logarithmic) {
                ...
                (s = b - t.dataPoints[D - 1].x),
                  0 > s && (s *= -1),
                  c.minDiff > s && 0 !== s && (c.minDiff = s);
              null !== e &&
                null !== t.dataPoints[D - 1].y &&
                (a.axisY.logarithmic
                  ? ((s = e / t.dataPoints[D - 1].y),
                    1 > s && (s = 1 / s),
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (b < da && !g) null !== p.dataPoints[q].y && (h = b);
            else {
              if (!g && ((g = !0), 0 < q)) {
                q -= 2;
                continue;
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (D = 0; D < t.dataPoints.length; D++)
            "undefined" !== typeof t.dataPoints[D].isCumulativeSum &&
            !0 === t.dataPoints[D].isCumulativeSum
              ? ((t.dataPointEOs[D].cumulativeSumYStartValue = 0),
                (t.dataPointEOs[D].cumulativeSum =
                  0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum),
                (t.dataPoints[D].y =
                  0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum))
              : "undefined" !== typeof t.dataPoints[D].isIntermediateSum &&
                !0 === t.dataPoints[D].isIntermediateSum
              ? ((t.dataPointEOs[D].cumulativeSumYStartValue = p),
                (t.dataPointEOs[D].cumulativeSum =
                  0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum),
                (t.dataPoints[D].y = 0 === D ? 0 : b),
                (p = 0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof t.dataPoints[D].y
                    ? 0
                    : t.dataPoints[D].y),
                (t.dataPointEOs[D].cumulativeSumYStartValue =
                  0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum),
                (t.dataPointEOs[D].cumulativeSum =
                  0 === D ? e : t.dataPointEOs[D - 1].cumulativeSum + e),
                (b += e));
          for (D = 0; D < t.dataPoints.length; D++)
            if (
              ("undefined" === typeof t.dataPoints[D].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              t.dataPointEOs[D].cumulativeSum < d.min &&
                (d.min = t.dataPointEOs[D].cumulativeSum),
              t.dataPointEOs[D].cumulativeSum > d.max &&
                (d.max = t.dataPointEOs[D].cumulativeSum),
              0 < D &&
                (a.axisX.logarithmic
                  ? ((p = b / t.dataPoints[D - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        t.dataPointEOs[D].cumulativeSum /
                        t.dataPointEOs[D - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < D &&
                (t.dataPointEOs[D - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = t.dataPointEOs[D - 1].cumulativeSum),
                t.dataPointEOs[D - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = t.dataPointEOs[D - 1].cumulativeSum));
              t.dataPointEOs[D].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = t.dataPointEOs[D].cumulativeSum);
              t.dataPointEOs[D].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = t.dataPointEOs[D].cumulativeSum);
            }
          t.axisX.valueType = t.xValueType = f ? "dateTime" : "number";
        }
    };
    ...
    m.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++)
        if (
          ...
          if (
            ((e = na("markerSize", b[c].dataPoint, b[c].dataSeries) || 8),
            b[c].distance <= e / 2)
          ) {
            d = !0;
            break;
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (q > g)
          var s = g,
            ...
            q = s;
        if (p.scaleBreaks)
          for (s = 0; !f && s < p.scaleBreaks._appliedBreaks.length; s++)
            f =
              p.scaleBreaks._appliedBreaks[s].startValue <= q &&
              p.scaleBreaks._appliedBreaks[s].endValue >= g;
          ...
          if (
            ...
            !(
              ...
              (!(
                ...
                ((p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3)) ||
                  (!p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)))) ||
              q < p.minimum ||
              g > p.maximum
            ))
          )
            D.push(p), n.push({ val1: q, val2: g }), (t = !0);
          else if (!e) {
            t = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var n = this._indexLabels[a],
          ...
          q,
          g,
          l = na("indexLabelFontColor", n.dataPoint, n.dataSeries),
        ...
        var H = n.dataPoint.indexLabelFormatter
          ? n.dataPoint.indexLabelFormatter(z)
          ...
          ? n.dataSeries.indexLabelFormatter(z)
        ...
        if (null !== H && "" !== H) {
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== x
              ? ((e = c.y1),
                ...
                0 < v
                  ? ((g =
                      n.point.y + ("horizontal" === z ? s / 2 : 0) - k - t - b),
                    g < e &&
                      ((g =
                        "auto" === x
                          ? Math.max(n.point.y, e) + s / 2 + t
                          : e + s / 2 + t),
                      (A = g + k > n.point.y)))
                  : ((g = n.point.y + s / 2 + t + b),
                    g > f - k &&
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ...
                        (A = q + D > n.point.x)))
                    : ((q =
                        n.point.x + ("horizontal" === z ? 0 : s / 2) + l + b),
                      q > f - D - l - b &&
                        ((q =
                          "auto" === x
          ...
          m &&
            ...
            d.setLineDash && d.setLineDash(J(da, m)),
            d.beginPath(),
            ...
            0 <= p.indexOf("bar") || ("error" === p && n.axisSwapped)
              ...
              ? d.lineTo(
                  q + D / 2 - ("horizontal" === z ? 0 : s / 2),
                  g +
                    ("vertical" === z
                      ? (g - k < n.point.y ? 0 : -k) + t
                      : (g - s / 2 < n.point.y ? k : 0) - s / 2)
                )
              : d.lineTo(
                  q + D / 2 - ("horizontal" === z ? 0 : s / 2),
                  g +
              ...
              if (
                ...
                if ("number" !== typeof n[u].y)
                  ...
                  r || z
                    ...
                    : (c.lineTo(m, x),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(m, x),
                        w && (b.stroke(), b.beginPath(), b.moveTo(m, x))));
                  l = { x: m, y: x };
                  u < n.length - 1 &&
                    (h !== (n[u].lineColor || s) ||
                  ...
                  if (0 < n[u].markerSize || 0 < k.markerSize) {
                    var C = k.getMarkerProperties(u, m, x, c);
                    f.push(C);
                    H = V(H);
                    w &&
                      f.push({
                  ...
                  u < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[u].markerSize || 0 < k.markerSize)
                    (H = k.getMarkerProperties(u, m, x, c)),
                      f.push(H),
                      (C = V(C)),
                      w &&
                        f.push({
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < s.length)
            for (
              ...
              if (
                (s[f].getTime ? (D = s[f].x.getTime()) : (D = s[f].x),
                !(
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < u.length)
            for (
              var m = 5 < s && r.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                p =
                  (p - (a.plotType.plotUnits.length * s) / 2 + a.index * s) <<
                  0;
                var x = (p + s) << 0,
                  z;
                if (
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < s.length) {
            ...
            for (var ea = !0; h < s.length; h++)
              if (
                ((m = s[h].x.getTime ? s[h].x.getTime() : s[h].x),
                !(
                  m < a.axisX.dataInfo.viewPortMin ||
                  (m > a.axisX.dataInfo.viewPortMax &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < p.length) {
            ...
            var C = "solid";
            if (b.setLineDash) {
              var A = J(n.nullDataLineDashType, n.lineThickness),
                C = n.lineDashType,
            ...
            for (s = !1; q < p.length; q++)
              if (
                ...
                if ("number" !== typeof p[q].y)
                  ...
                  q < p.length - 1 &&
                    (H !== (p[q].lineColor || z) ||
                      C !== (p[q].lineDashType || n.lineDashType)) &&
                    ((H = p[q].lineColor || z),
                  ...
                  if (
                    ...
                    var S = n.getMarkerProperties(q, g, s, b);
                    l.push(S);
                    L = V(L);
                    w &&
                      l.push({
    ...
    m.prototype.renderStepArea = function (a) {
      ...
      function b() {
        H &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(m, z), l.lineTo(H.x, z), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(m, u),
          l.beginPath(),
          l.moveTo(m, u),
            ...
            for (var $ = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  q < v.length - 1 &&
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ...
                        : ((x = C.lineDashType), b.setLineDash(B))));
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < C.markerSize) &&
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < C.markerSize) &&
                    ((la = C.getMarkerProperties(q, g, s, b)),
                    t.push(la),
                    (f = V(F)),
                    w &&
                      t.push({
              ...
              if (
                ...
                (y[t].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: y[t],
                    dataSeries: u,
                    point: { x: z + (H - z) / 2, y: a.axisY.reversed ? p : n },
                    direction: 1,
                    bounds: {
                      x1: z,
                      y1: Math.min(n, p),
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var m = !1, m = !!a.axisY.reversed, da = 0;
            ...
            for (
              ...
              if (
                ...
                0 < la &&
                  ...
                  (c.strokeStyle = oa),
                  (c.lineWidth = la),
                  c.setLineDash && c.setLineDash(J(E, la)),
                  c.moveTo(t - F, k),
                  c.lineTo(t - F, h),
                  c.stroke(),
                  c.moveTo(t - F, p),
                ...
                0 < G &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(J(O, G)),
                  (c.strokeStyle = K),
                  (c.lineWidth = G),
                  c.moveTo(v, q - N),
                  c.lineTo(C, q - N),
          ...
          if (0 < g.length)
            for (
              ...
              if (
                ...
                Y(
                  c,
                  a.axisX.reversed ? da : m,
                  l,
                  a.axisX.reversed ? m : da,
                  t,
                  b,
                  0,
                  b,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          t = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (C ? da : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (t = this.options.dataPointMaxWidth
          ...
          if (0 < v.length)
            for (var E = z._colorSet, t = 0; t < v.length; t++) {
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((C ? da : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0
                      : (k - ((C ? da : 1) * u) / 2 + (C ? A - 1 : 0) * u) <<
                        0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((n = a.axisX.reversed
                      ? (h + ((C ? da : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0
                      : (h - ((C ? da : 1) * u) / 2 + (C ? A - 1 : 0) * u) <<
                        0),
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (v[t].y[1] >= v[t].y[0] ? n : p) : n + (p - n) / 2,
            ...
            for (var L = !0; g < p.length; g++)
              if (
                ...
                if (
                  ...
                  g < p.length - 1 &&
                    (A !== (p[g].lineColor || v) ||
                      C !== (p[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (A = p[g].lineColor || v),
                  ...
                  if (
                    ...
                    S = n.getMarkerProperties(g, s, r, b);
                    f.push(S);
                    ea = V(u);
                    w &&
                      f.push({
            ...
            for (g = !1; p < n.length; p++)
              if (
                ...
                if (
                  ...
                  p < n.length - 1 &&
                    (x !== (n[p].lineColor || y) ||
                      z !== (n[p].lineDashType || k.lineDashType)) &&
                    ((x = n[p].lineColor || y),
          ...
          if (0 < m.length)
            for (
              ...
              if (
                ...
                Y(
                  c,
                  a.axisX.reversed ? E : t,
                  a.axisY.reversed ? k : h,
                  a.axisX.reversed ? t : E,
    ...
    m.prototype.renderPie = function (a) {
            ...
            for (var t, r, a = 0; a < n.length; a++) {
              ...
              if (null !== u) {
                ...
                var z = 0,
                  z = b(t, r) - s;
                if (0 > z) {
                  for (var A = (r = 0), H = 0; H < n.length; H++)
                    H !== a &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var A = 0; A < n.length; A++)
          (z += Math.abs(n[A].y)),
            !a &&
              "undefined" !== typeof n[A].indexLabel &&
              null !== n[A].indexLabel &&
              0 < n[A].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof n[A].label &&
              null !== n[A].label &&
              0 < n[A].label.toString().length &&
              (a = !0);
        if (0 !== z) {
          a =
            a ||
        ...
        if (e)
          for (l = I.length - 1; 0 <= l; l--)
            (a = R[l]),
              ...
              u.reversed
                ? (I[l].textBlock.y + I[l].height > U + z &&
                    (I[l].textBlock.y = U + z - I[l].height),
                  I[l].textBlock.y < ta - z && (I[l].textBlock.y = ta - z))
                : (I[l].textBlock.y < U - z && (I[l].textBlock.y = U - z),
                  I[l].textBlock.y + I[l].height > ta + z &&
                    (I[l].textBlock.y = ta + z - I[l].height));
      }
      function f() {
        var a, b, c, d;
      ...
      function l() {
          ...
          for (var k, h = 1; h < l; h++) {
            ...
            for (var t = I.length - 1; 0 <= t; t--)
              !I[t].isDirty &&
                ...
                ((k = q(t)),
                !(k >= I.length - 1) &&
                  I[t].textBlock.y + I[t].height + ca > I[k].textBlock.y &&
                  (I[t].textBlock.y =
          ...
          for (k = R.length - 1; 0 < k; k--)
            if (!I[k].isDirty) {
              ...
              if (I[k].textBlock.y < I[e].textBlock.y + I[e].height) {
                ...
                for (
                  l = 0;
                  I[f].textBlock.y < I[e].textBlock.y + I[e].height + ca;
        ...
        for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
          for (
            ...
            (f = I[s]),
            (g = f.textBlock),
            (k = (l = q(s) < R.length ? I[q(s)] : null) ? l.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              l &&
              e + d + ca > +k.y.toFixed(6) &&
              ((d = g.y + d + ca - k.y),
              (e = a(s, -d)),
              e < d && (0 < e && (d -= e), (e = a(q(s), d)), e != d)));
            s--
          );
          b();
        }
      ...
      function m(a, b, c) {
        ...
        if (0 === Z.length) l = ia;
          ...
          for (var t = 0; t < R.length; t++) {
            ...
            l.push(ia[t] + d);
            if (0 <= Z.indexOf(t) || (t < R.length && 0 <= Z.indexOf(t + 1)))
              d += e;
          }
        }
        g = (function () {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== S) {
            ...
            if (u.reversed)
              for (F = 0; F < S.length; F++)
                G[F] < Ba
                  ? (a.push(N), B.push(X), (ba = F))
                  : (a.push((G[F] - U + aa * T) / aa),
                    B.push((G[F] - U + fa * W) / fa));
            else
              for (F = 0; F < S.length; F++)
                G[F] < Ba
                  ? (a.push((G[F] - U + aa * T) / aa),
            ...
            for (F = 0; F < R.length; F++)
              (C = R[F]), sa(P, C, u.fillOpacity), ia.push(C.y1);
            v(P);
            L &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || A.animationEnabled || n(P),
            ...
            !A.animationEnabled && S
              ? m(A, -1, 0)
              : A.animationEnabled && !A.animatedRender && m(A, -1, 0);
      ...
      for (var h = 0, r = 0; r < l.length; r++) {
        for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
          ...
          this.ghostCtx.fillRect(
            ...
            q.textBlock.x + q.textBlock.width - m,
            q.textBlock.height
          );
            ...
            if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[n]
                  : ca(n, this.valueFormatString, this.chart._cultureInfo)),
                (a = new ka(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: f,
    ...
    A.setLayout = function (a, d, c, b, e, f) {
      ...
      if ("normal" === e) {
        for (
          ...
          if (c && 0 < c.length)
            for (z = [], g = R = 0; g < c.length; g++)
              z.push(
                ...
                (R += z[g]),
                (N += c[g] && !n.isNavigator ? c[g].margin : 0);
          else
          ...
          m = Math.round(
            f.x2 - aa - Z > n.width - p ? n.width - p : f.x2 - aa - Z
          );
          if (a && 0 < a.length)
            for (y = [], g = X = 0; g < a.length; g++)
                ...
                !a[g] ||
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < E && (l += E), 0 < h && (m -= h))),
                n.panEnabled
                  ? (X = r(n.sessionVariables.axisX.height)
                      ? (n.sessionVariables.axisX.height = X)
                      : n.sessionVariables.axisX.height)
                  : (n.sessionVariables.axisX.height = X),
                (h = Math.round(f.y2 - X - e + F)),
                (k = Math.round(f.y2)),
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + R + N)),
                ...
                (d[g].lineCoordinates.y1 = h + Y + W - V),
              ...
              b[g] &&
                ...
                (N =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + Y + W < Math.max(N, p) ? Math.max(N, p) : f.y1 + Y + W
                )),
                (N =
                  0 < a.length
                    ? 0
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(
                  f.x2 - X - W > n.width - 10 ? n.width - 10 : f.x2 - X - W
                )),
                c[g].labelAutoFit &&
                  !r(y) &&
                  (0 < !a.length &&
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - T > n.height - Math.max(N, 10)
                        ? n.height - Math.max(N, 10)
                        : f.y2 - T
                    )
                  : f.y2 > n.height - Math.max(N, 10)
                  ? n.height - Math.max(N, 10)
                  : f.y2;
              if (c && 0 < c.length)
                  ...
                  c[N] &&
                    ...
                    ((m =
                      0 > c[N].labelAngle
                        ...
                        : m),
                    (l =
                      0 > c[N].labelAngle || 0 === c[N].labelAngle
                        ? m - U
                        : l));
              if (b && 0 < b.length)
                for (N = 0; N < b.length; N++)
                  b[N] &&
                    b[N].labelAutoFit &&
                    ((m = b[N].lineCoordinates.x1), (l = m - U));
              a[g].lineCoordinates = {
                x1: m - O,
                y1: h,
                x2: m - O,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (N = 0; N < b.length; N++)
                  b[N] &&
                    b[N].labelAutoFit &&
                    ((m = b[N].lineCoordinates.x2), (l = m - X));
              d[g].lineCoordinates = {
                x1: m + P,
                y1: h,
                x2: m + P,
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(n[B].dataPoint.y[0])
                ),
                u = 0,
                s = 0;
              s < n.length;
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (var y = 0; y < n[s].dataPoint.y.length; y++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(n[s].dataPoint.y[y])
                  )),
                    u < v && ((v = u), (B = s));
              else
                (u = Math.abs(
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (y = 0; y < n[s].dataPoint.y.length; y++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(n[s].dataPoint.y[y])
                  )),
                    u < v && ((v = u), (B = s));
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                ...
                (x += n[s].dataPoint.y),
                  (z = n[s].dataPoint.x.getTime
                    ? n[s].dataPoint.x.getTime()
                    : n[s].dataPoint.x),
                  (z = 100 * (x / n[s].dataSeries.plotUnit.dataPointYSums[z])),
          ...
          if (
            ...
            for (
              ...
              if (n[s].dataPoint.y && n[s].dataPoint.y.length)
                for (y = 0; y < n[s].dataPoint.y.length; y++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(n[s].dataPoint.y[y])
                  )),
                    u < v && ((v = u), (B = s));
              else
                (u = Math.abs(

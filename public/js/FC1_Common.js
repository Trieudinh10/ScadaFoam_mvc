...
var tags = ['Total_Energy', 'Total_power'];
...
function fn_iotag(tag){
    ...
    console.log('abcdefg', Total_Energy);
    console.log('abcdefg', Total_power);
...
function calculate_table1() {
    ...
    Buong_ngayt = values['Total_Energy'];
    Tan_ngayt = values['Total_power'];
